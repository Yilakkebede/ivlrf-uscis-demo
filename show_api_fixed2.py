...
def demonstrate_us_government_apis():
    ...
    print(f"\n[DATE] Demonstration Date: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    print("[LOCATION] Target: California (CA), Year: 2023")
    print("\n" + "-"*70)
...
def demonstrate_phd_model_integration():
    ...
    models = [
        ...
        ("Scrap Elasticity  = -0.7", "Jacobsen & van Benthem (2015) + PhD Ch5",
    ...
    print("\n" + "-"*70)
    print("[RESULTS] QUANTIFIED RESULTS FROM PHD MODELS:")
...
def generate_agency_outputs():
    ...
    print("\n" + "-"*70)
    print("[IMPACT] NATIONAL IMPACT DELIVERED:")
